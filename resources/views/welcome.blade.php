                                    ...
                                    <div class="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                                        <div class="lg:pr-8 lg:pt-4">
                                            <div class="lg:max-w-lg">
                                                <h2 class="text-3xl sm:text-5xl font-bold text-pretty text-white">
                                                    Rejoignez ÉcoSense pour découvrir un monde d'apprentissage et de défis écologiques!
                                                </h2>
                                                <p class="mt-6 text-lg/8 text-white">
                                                    En vous connectant, vous aurez accès à :
                                                </p>
                                                <dl class="mt-10 max-w-xl space-y-8 text-base/7 text-gray-600 lg:max-w-none">
                                                    <div class="relative pl-9">
                                                        <dt class="inline font-semibold text-white">
                                                            <span class="mr-2">•</span>Des articles exclusifs pour approfondir vos connaissances
                                                        </dt>
                                                    </div>
                                                    <div class="relative pl-9">
                                                        <dt class="inline font-semibold text-white">
                                                            <span class="mr-2">•</span>Des formations interactives pour adopter des gestes durables
                                                        </dt>
                                                    </div>
                                                    <div class="relative pl-9">
                                                        <dt class="inline font-semibold text-white">
                                                            <span class="mr-2">•</span>Un système de points XP pour récompenser vos progrès
                                                        </dt>
                                                    </div>
                                                    <div class="relative pl-9">
                                                        <dt class="inline font-semibold text-white">
                                                            <span class="mr-2">•</span>Un classement pour vous comparer à vos amis et à la communauté
                                                        </dt>
                                                    </div>
                                                    <div class="relative pl-9">
                                                        <dt class="inline font-semibold text-white">
                                                            <span class="mr-2">•</span>Des défis et missions pour gagner encore plus de points !
                                                        </dt>
                                                    </div>
                                                </dl>
                                            </div>
                                        </div>
                                        <img src="https://image.noelshack.com/fichiers/2024/45/3/1730878019-mockups.jpg" alt="Product screenshot" class="max-w-none rounded-xl md:-ml-4 lg:-ml-0 w-full">
                                    </div>
                                </div>
                            </div>
                        </div>
